...
#define UTIL_GET_CALLBACK_FACTORY_BIND_FREE(freeFuncPtr) \
    (feta::GetCallbackFactory(freeFuncPtr).Bind<freeFuncPtr>())
...
#define UTIL_GET_CALLBACK_FACTORY_BIND_MEMBER(memFuncPtr, instancePtr) \
    (feta::GetCallbackFactory(memFuncPtr).Bind<memFuncPtr>(instancePtr))
...
private:
	...
	Callback(FuncType f, const void* o) :
			func(f), obj(o) {
	}
...
template<typename R>
inline FreeCallbackFactory0<R> GetCallbackFactory(R (*)()) {
...
template<typename R, class T>
inline MemberCallbackFactory0<R, T> GetCallbackFactory(R (T::*)()) {
...
template<typename R, class T>
inline ConstMemberCallbackFactory0<R, T> GetCallbackFactory(R (T::*)() const) {
...
public:
	...
	Callback(NullCallback nullCallback) :
			func(0), obj(0) {
	}
	Callback(const Callback& rhs) :
			func(rhs.func), obj(rhs.obj) {
	...
	Callback& operator=(NullCallback nullCallback) {
		obj = 0;
		func = 0;
		return *this;
	}
...
template<typename R, typename P1>
void operator==(const Callback<R(P1)>&, const Callback<R(P1)>&);
template<typename R, typename P1>
void operator!=(const Callback<R(P1)>&, const Callback<R(P1)>&);
...
template<typename R, typename P1>
inline FreeCallbackFactory1<R, P1> GetCallbackFactory(R (*)(P1)) {
...
template<typename R, class T, typename P1>
inline MemberCallbackFactory1<R, T, P1> GetCallbackFactory(R (T::*)(P1)) {
...
template<typename R, class T, typename P1>
inline ConstMemberCallbackFactory1<R, T, P1> GetCallbackFactory(
		R (T::*)(P1) const) {
...
template<typename R, typename P1, typename P2>
void operator==(const Callback<R(P1, P2)>&, const Callback<R(P1, P2)>&);
template<typename R, typename P1, typename P2>
void operator!=(const Callback<R(P1, P2)>&, const Callback<R(P1, P2)>&);
...
template<typename R, typename P1, typename P2>
inline FreeCallbackFactory2<R, P1, P2> GetCallbackFactory(R (*)(P1, P2)) {
...
template<typename R, class T, typename P1, typename P2>
inline MemberCallbackFactory2<R, T, P1, P2> GetCallbackFactory(
		R (T::*)(P1, P2)) {
...
template<typename R, class T, typename P1, typename P2>
inline ConstMemberCallbackFactory2<R, T, P1, P2> GetCallbackFactory(
		R (T::*)(P1, P2) const) {
...
template<typename R, typename P1, typename P2, typename P3>
void operator==(const Callback<R(P1, P2, P3)>&, const Callback<R(P1, P2, P3)>&);
template<typename R, typename P1, typename P2, typename P3>
void operator!=(const Callback<R(P1, P2, P3)>&, const Callback<R(P1, P2, P3)>&);
...
public:
	...
	inline static Callback<R(P1, P2, P3)> Bind() {
		return Callback<R(P1, P2, P3)>(&FreeCallbackFactory3::Wrapper<Func>, 0);
	}
};

template<typename R, typename P1, typename P2, typename P3>
inline FreeCallbackFactory3<R, P1, P2, P3> GetCallbackFactory(
		R (*)(P1, P2, P3)) {
...
public:
	...
	inline static Callback<R(P1, P2, P3)> Bind(T* o) {
		return Callback<R(P1, P2, P3)>(&MemberCallbackFactory3::Wrapper<Func>,
				static_cast<const void*>(o));
	}
};

template<typename R, class T, typename P1, typename P2, typename P3>
inline MemberCallbackFactory3<R, T, P1, P2, P3> GetCallbackFactory(
		R (T::*)(P1, P2, P3)) {
...
template<typename R, class T, typename P1, typename P2, typename P3>
inline ConstMemberCallbackFactory3<R, T, P1, P2, P3> GetCallbackFactory(
		R (T::*)(P1, P2, P3) const) {
...
public:
	...
	inline static Callback<R(P1, P2, P3, P4)> Bind() {
		return Callback<R(P1, P2, P3, P4)>(&FreeCallbackFactory4::Wrapper<Func>,
				0);
	}
};

template<typename R, typename P1, typename P2, typename P3, typename P4>
inline FreeCallbackFactory4<R, P1, P2, P3, P4> GetCallbackFactory(
		R (*)(P1, P2, P3, P4)) {
...
template<typename R, class T, typename P1, typename P2, typename P3, typename P4>
inline MemberCallbackFactory4<R, T, P1, P2, P3, P4> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4)) {
...
template<typename R, class T, typename P1, typename P2, typename P3, typename P4>
inline ConstMemberCallbackFactory4<R, T, P1, P2, P3, P4> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4) const) {
...
template<typename R, typename P1, typename P2, typename P3, typename P4,
		typename P5>
inline FreeCallbackFactory5<R, P1, P2, P3, P4, P5> GetCallbackFactory(
		R (*)(P1, P2, P3, P4, P5)) {
...
template<typename R, class T, typename P1, typename P2, typename P3,
		typename P4, typename P5>
inline MemberCallbackFactory5<R, T, P1, P2, P3, P4, P5> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4, P5)) {
...
template<typename R, class T, typename P1, typename P2, typename P3,
		typename P4, typename P5>
inline ConstMemberCallbackFactory5<R, T, P1, P2, P3, P4, P5> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4, P5) const) {
...
template<typename R, typename P1, typename P2, typename P3, typename P4,
		typename P5, typename P6>
inline FreeCallbackFactory6<R, P1, P2, P3, P4, P5, P6> GetCallbackFactory(
		R (*)(P1, P2, P3, P4, P5, P6)) {
...
template<typename R, class T, typename P1, typename P2, typename P3,
		typename P4, typename P5, typename P6>
inline MemberCallbackFactory6<R, T, P1, P2, P3, P4, P5, P6> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4, P5, P6)) {
...
template<typename R, class T, typename P1, typename P2, typename P3,
		typename P4, typename P5, typename P6>
inline ConstMemberCallbackFactory6<R, T, P1, P2, P3, P4, P5, P6> GetCallbackFactory(
		R (T::*)(P1, P2, P3, P4, P5, P6) const) {
